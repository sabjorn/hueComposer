...
import numpy as np
from matplotlib.colors import hsv_to_rgb #used for HSV conversion
...
class ColorHelper:
    ...
    def getXYPointFromRGB(self, red, green, blue, clip=True):
        ...
        # if color is unreachable, clip to color space.
        if clip is True:
...
class Converter:
    ...
    def hexToCIE(self, h):
        ...
        return self.rgbToCIE(rgb[0], rgb[1], rgb[2])

    def rgbToCIE(self, r, g, b, clip=True):
        ...
        May not produce accurate values.
        """
        point = self.color.getXYPointFromRGB(r, g, b, clip)
        return [point.x, point.y]

    def hsvToCIE(self, h, s, v, clip=True):
        """ A wrapper for matplotlib hsv_to_rgb """
